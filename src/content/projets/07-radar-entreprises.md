...
| Aucune reprise sur les tâches de contrôle | Les deux reprises par défaut | Un échec de qualité est déterministe : le rejouer ne change rien. Mesuré en intégration continue, une parution refusée coûtait **1 676 s** avec deux reprises et attente exponentielle, contre 19 s sans |
