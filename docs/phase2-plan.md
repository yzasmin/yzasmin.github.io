...
| 5 | agent-ia-llm | re2020-assistant-rag | documents RE2020, clé Anthropic | dépôt poussé, récupération mesurée (hybride : rappel@10 0,875, MRR 0,541, nDCG@10 0,614) ; génération non évaluée, la clé du poste n'est rattachée à aucun espace de travail (en-tête anthropic-workspace-id manquant) |
...
| T | teasers | (site) | 1 à 6 livrent `teaser/` | gabarit `video/teaser-projet` prêt (17 s, check sans erreur) ; projets 1, 2, 3, 4 et 6 rendus ; reste le 5 |
